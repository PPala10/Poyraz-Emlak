# AirBnbClone - Reservation & iyzico Payment System - Poyraz Emlak
...
* **Hosted Checkout Form Architecture:** Utilizes the official iyzico .NET SDK (`Iyzipay`) to render secure, PCI-DSS compliant payment forms natively.
